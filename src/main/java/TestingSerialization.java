...
public class TestingSerialization {
    public static void main(String[] args) {
        ...
        runTests(oldSerializer, 100, 500, 1000, 5000, 10000, 15000);

        Serializer jsonSerialization = new JacksonSerialization();
        runTests(jsonSerialization, 100, 500, 1000, 5000, 10000, 15000);

        Serializer fstSerialization = new FstSerialization();
        runTests(fstSerialization, 100, 500, 1000, 5000, 10000, 15000);
    }
    ...
    private static Result runTest(Serializer serializer, int size) {
        ...
        String s = size + "-" + UUID.randomUUID().toString();
